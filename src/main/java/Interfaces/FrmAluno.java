...
public class FrmAluno extends javax.swing.JFrame {
    ...
    public FrmAluno() throws ParseException, SQLException {
        this.alunoEdit = null;
        lista = new ArrayList<>();
        initComponents();
        carregarTabela();
    ...
    public void habilitarCampos(boolean flag){
        ...
        edtMensalidade.setEnabled(flag);
    ...
    public void limparCampos(){
     ...
     public void objetosParaCampos(JTable tableCategories, int row) {
        ...
        this.row = row;
        edtId.setText(tblAluno.getModel().getValueAt(row, 0).toString());
        edtNome.setText(tblAluno.getModel().getValueAt(row, 1).toString());
        edtCpf.setText(tblAluno.getModel().getValueAt(row, 2).toString());
        edtEndereco.setText(tblAluno.getModel().getValueAt(row, 3).toString());
        edtIdade.setText(tblAluno.getModel().getValueAt(row, 4).toString());
        edtMensalidade.setText(tblAluno.getModel().getValueAt(row, 5).toString());
      ...
      public void carregarTabela() throws SQLException{
        ...
        while (data.next()) {
            ...
            model.addRow(new Object[]{data.getString("id_aluno"), data.getString("nome"), data.getString("cpf"), data.getString("endereco"), data.getString("idade"), data.getString("mensalidade")});
        }
      }
    ...
    private void initComponents() {
        ...
        edtMensalidade = new javax.swing.JTextField();
        ...
        lblTitulo.setText("Gerenciamento de Alunos");
        ...
        lblMensalidade.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        ...
        pnlFormLayout.setHorizontalGroup(
            ...
            .addGroup(pnlFormLayout.createSequentialGroup()
                ...
                .addGroup(pnlFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(edtMensalidade, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        pnlFormLayout.setVerticalGroup(
            ...
            .addGroup(pnlFormLayout.createSequentialGroup()
                ...
                .addGroup(pnlFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(edtMensalidade, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        tblAluno.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "nome", "cpf", "endereço", "idade", "mensalidade"
            }
        ) {
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        int row = this.tblAluno.getSelectedRow(); 
        if (row >= 0) {
            selectedId = 1;
            habilitarCampos(true);
            objetosParaCampos(this.tblAluno, row);
    ...
    private javax.swing.JTextField edtMensalidade;
